...
/**
 * Factory para criar um gerenciador de conexao com o banco de dados da
 * aplicacao
 * 
 * @author ggarcia
 *
...
public final class ConectorBD {
	...
	/**
	 * Nome da unidade de persistencia de compromissos definido no arquivo
	 * persistence.xml
	 */
	public static final String COMPROMISSO_PU = "CompromissoPU";

	/**
	 * Mapa que contem as fabricas de entidades persistentes fornecida pela API
	 * do JPA
	 */
